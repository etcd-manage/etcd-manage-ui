                ...
                <div class="search-form">
                    <Form :model="search" inline>
                        ...
                        <FormItem label="用户名:" :label-width="80">
                            <Input v-model="search.name" @on-enter="getList" placeholder="用户名..." style="width:200px;"/>
                        </FormItem>
                        <FormItem label="用户ID:" :label-width="80">
                            <Input v-model="search.userId" @on-enter="getList" placeholder="用户ID..." style="width:100px;"/>
                        </FormItem>
                        <FormItem>
...
export default {
    ...
    methods:{
        ...
        // 获取列表数据
        getList(){
            User.GetList(this.search.userId, this.search.name, this.search.roleId, this.page, this.pageSize).then(response => {
                if(response.status == 200){
